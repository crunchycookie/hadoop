package org.apache.hadoop.yarn.dtss.nm;
/**
...
public class MockNM {
  private static final Logger LOG = Logger.getLogger(MockNM.class.getName());
  ...
  private Map<ContainerId, ContainerStatus> containerStats = new HashMap<>();
